...
> = {
  ...
  js: {
    category: 'Inspection',
    description: 'Run JavaScript expression and return result as string',
    usage: 'js <expr>',
  },
  eval: {
    category: 'Inspection',
  ...
  is: {
    category: 'Inspection',
    description: 'State check (visible/hidden/enabled/disabled/checked/editable/focused)',
    usage: 'is <prop> <sel>',
  },
  console: {
    category: 'Inspection',
  ...
  scroll: {
    category: 'Interaction',
    description: 'Scroll element into view, or scroll to page bottom if no selector',
    usage: 'scroll [sel]',
  },
  wait: {
    category: 'Interaction',
  ...
  screenshot: {
    category: 'Visual',
    description: 'Save screenshot (supports element crop via CSS/@ref, --clip region, --viewport)',
    usage: 'screenshot [--viewport] [--clip x,y,w,h] [selector|@ref] [path]',
  },
  ...
  chain: {
    category: 'Meta',
    description: 'Run commands from JSON stdin. Format: [["cmd","arg1",...],...]',
  },
  // Handoff
  handoff: {
    category: 'Server',
