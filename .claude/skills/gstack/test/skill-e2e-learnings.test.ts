    ...
    const learnings = [
      {
        ...
        insight:
          'ActiveRecord associations in loops cause N+1 queries. Always use includes/preload.',
        confidence: 9,
        source: 'observed',
...
- Just show the learnings and summarize what you found.`,
      ...
      if (foundCount === 3) {
        ...
        console.warn(
          `Only ${foundCount}/3 learnings found (N+1: ${mentionsNPlusOne}, cache: ${mentionsCache}, rubocop: ${mentionsRubocop})`,
        );
      }
    },
    180_000,
